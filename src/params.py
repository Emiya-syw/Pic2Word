...
def parse_args():
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "inet", "auto", "inet,csv", "csv,inet", "directory", "fashion-iq", "cirr", "imgnet_r","flow_matching","mtcir","cc3m"],
        default="auto",
    ...
    parser.add_argument(
        ...
        choices=["global"],
        default="global",
        help="Choose global embedding flow matching.",
    )
    parser.add_argument(
        "--flow-hidden-dim",
        type=int,
